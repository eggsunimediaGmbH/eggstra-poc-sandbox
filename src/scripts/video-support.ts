const DM_VIDEO_SERVER_URL: string = 'https://s7g10.scene7.com/is/content';
const DM_SERVER_URL: string = 'https://s7g10.scene7.com/is/image';

export function isAdobeCloud(): boolean {
...
export function isVideoLink(link: HTMLElement) {
