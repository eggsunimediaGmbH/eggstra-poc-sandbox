...
function equalizeHeights(element) {
    ...
    const descriptions = element.querySelectorAll('.case-study__card-description');
    const titles = element.querySelectorAll('.case-study__card-title');
...
observeElement('.case-study.block', function (element) {
